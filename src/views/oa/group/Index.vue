  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      <div class="table-operator">
        <a-button type="primary" icon="plus" @click="handleAdd" v-action:Group-Store>新增</a-button>
      </div>
      ...
      >
        <span slot="action" slot-scope="text, record">
          <template>
            <a @click="handleEdit(record)" v-if="$auth('Group-Update')">编辑</a>
            <a-divider type="vertical" />
            <a @click="handleDel(record)" v-if="$auth('Group-Delete')">删除</a>
          </template>
        </span>
      </s-table>
...
import { Index, Store, Update, Delete } from '@/api/group'
